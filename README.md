...
uv add "python-setup @ git+https://github.com/szavadsky/python-setup.git@v0.13.0"
```
...
```bash
uv add --dev "python-setup @ git+https://github.com/szavadsky/python-setup.git@v0.13.0"
```
...
1. Update the dependency: `uv add "python-setup @ git+https://github.com/szavadsky/python-setup.git@v0.13.0"`
