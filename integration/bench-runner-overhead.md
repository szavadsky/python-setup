...
|------|--------------:|--------------:|----------:|
| tach check | 0.171 | 0.0 | 1 |
| ruff check | 0.01 | 0.0 | 1 |
| rumdl check | 0.004 | 0.0 | 0 |
| mypy | 0.631 | 0.0 | 0 |
| yamllint | 0.086 | 0.0 | 0 |
| ty check | 0.057 | 0.0 | 0 |
| pyright check | 0.523 | 0.0 | 0 |
| pylint (no plugins) | 0.32 | 0.0 | 24 |
| pylint (stdlib only) | 0.312 | 0.0 | 24 |
| pylint (all custom) | 0.344 | 0.0 | 30 |
| detect-secrets | 0.129 | 0.0 | 0 |

## Runner Overhead (before optimisation)

| Metric | Value |
|--------|------:|
| Total `run_lint` wall-time | 2.136s |
| Sum of per-tool subprocess time | 2.135s |
