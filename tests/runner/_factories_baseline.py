...
DIFF_BASELINE_CASES: list[Any] = [
    _p({"tool": "ruff check", "exit_code": 0, "output": "src/a.py:1: error A\nsrc/b.py:2: error B"}, {"ruff check": "src/a.py:1: error A", "mypy": "src/c.py:3: error C"}, "no_violations", "ruff_shrunk_b_removed", id="pure_shrinkage_auto_records"),
    _p({"tool": "ruff check", "exit_code": 0, "output": "src/a.py:1: error A"}, {"ruff check": "src/a.py:1: error A\nsrc/b.py:2: error B"}, "output changed", "no_post", id="pure_addition_flags_regression"),
    _p({"tool": "ruff check", "exit_code": 0, "output": "src/a.py:1: error A\nsrc/b.py:2: error B"}, {"ruff check": "src/a.py:1: error A\nsrc/c.py:3: error C"}, "output changed", "b_removed_c_not_added", id="mixed_shrinkage_and_addition"),
    _p({"tool": "pylint", "exit_code": 0, "output": "1 src/a.py:1:1: W0611: unused-import\n1 src/b.py:2:2: C0114: missing-module-docstring"}, {"pylint": "src/a.py:1:1: W0611: unused-import"}, "no_violations", "c0114_removed", id="pylint_shrinkage_auto_records"),
    _p({"tool": "ruff check", "exit_code": 0, "output": "ok"}, {"ruff check": "ok"}, "no_violations", "mypy_removed", id="tool_removed_shrinkage_auto_records"),
    _p({"tool": "pyright check", "exit_code": 0, "diagnostics": {"summary": {"errorCount": 2, "warningCount": 0}}}, {"pyright check": {"summary": {"errorCount": 1, "warningCount": 0}}}, "no_violations", "diag_count_1", id="diagnostics_shrinkage_auto_records"),
    _p({"tool": "pylint", "exit_code": 0, "output": "1 src/a.py:1:1: W0611: unused-import"}, {"pylint": "src/a.py:1:1: W0611: unused-import\nsrc/b.py:2:2: C0114: missing-module-docstring"}, "output changed", "no_post", id="pylint_addition_flags_regression"),
    _p({"tool": "rumdl check", "exit_code": 0, "output": "src/a.md:1 MD012 (10ms)\nsrc/b.md:3 MD013 (20ms)"}, {"rumdl check": "src/a.md:1 MD012 (5ms)"}, "no_violations", "md013_removed", id="rumdl_shrinkage_auto_records_ignoring_timing"),
    _p({"tool": "mypy", "exit_code": 0, "output": "src/a.py:1: error"}, {"mypy": ""}, "no_violations", "output_emptied", id="output_to_empty_shrinkage"),
    _p({"tool": "mypy", "exit_code": 0, "output": "src/a.py:1: error A  \nsrc/b.py:2: error B  "}, {"mypy": "src/a.py:1: error A\nsrc/b.py:2: error B"}, "no_violations", "no_post", id="whitespace_normalization_d6"),
    _p({"tool": "mypy", "exit_code": 0, "output": "src/a.py:1: error A"}, {"mypy": "src/a.py:1: error A\nsrc/a.py:1: error A\nsrc/a.py:1: error A"}, "no_violations", "no_post", id="duplicate_line_count_set_semantics_d7"),
    _p({"tool": "ruff check", "exit_code": 0, "output": "src/a.py:1: error A\nsrc/b.py:2: error B"}, {"ruff check": "src/b.py:2: error B\nsrc/a.py:1: error A"}, "no_violations", "no_post", id="ruff_ordering_insensitive"),
    _p({"tool": "pyright check", "exit_code": 0, "diagnostics": {"summary": {"errorCount": 1, "warningCount": 0}}}, {"pyright check": "non-JSON"}, "diagnostics lost", "diag_preserved", id="diagnostics_lost_regression_d4"),
    _p({"tool": "ruff check", "exit_code": 0, "output": "src/a.py:1: error A"}, {"ruff check": "src/a.py:1: error A"}, "no_violations", "all_mypy_dupes_removed", id="duplicate_tool_in_baseline_d3"),
]
...
def build_current_results(
    ...
    saved_entries = [saved_baseline] if isinstance(saved_baseline, dict) else saved_baseline
...
DIFF_EDGE_CASES: list[Any] = [
    _p({"tool": "pyright check", "exit_code": 0, "diagnostics": {"summary": {"errorCount": 1, "timeInSec": 10.0, "filesAnalyzed": 100}}}, {"pyright check": {"summary": {"errorCount": 1, "timeInSec": 15.0, "filesAnalyzed": 100}}}, "no_violations", id="pyright_ignores_time_in_sec"),
    _p({"tool": "pyright check", "exit_code": 0, "diagnostics": {"summary": {"errorCount": 1}}}, {"pyright check": {"summary": {"errorCount": 1}}}, "no_violations", id="diagnostics_used_when_present"),
    _p({"tool": "test", "exit_code": 0, "output": "ok"}, {"test": "ok"}, "no_violations", id="identical"),
]

DIFF_EDGE_INVARIANTS: list[Any] = [
    _p({"tool": "test", "exit_code": 0, "output": "ok"}, [_make_result("test", exit_code=1, stdout="ok")], "exit code", id="exit_code_changed_flags_regression"),
    _p({"tool": "mypy", "exit_code": 1, "output": "some error"}, [_make_result("mypy", exit_code=0, stdout="")], "no_violations", id="exit_code_shrinkage_auto_records"),
    _p({"tool": "tool_a", "exit_code": 0, "output": ""}, [_make_result("tool_a"), _make_result("tool_b")], "no baseline entry", id="new_tool_flags_regression"),
]
