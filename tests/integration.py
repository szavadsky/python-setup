...
class TestMinimalSampleProject:
    ...
    def test_config_overlay(
        ...
        pylintrc_content = pylintrc_content.replace(
            ...
            "enable=too-many-statements,too-many-branches,too-many-locals,too-many-nested-blocks,too-many-public-methods,too-complex,no-try-import,missing-beartype,tempfile-mkdtemp-in-test,asyncio-timeout,missing-module-stub,missing-import-declaration,missing-module-stub-for-import,star-import-unresolvable,signature-mismatch,annotation-mismatch,impl-missing-annotation,annotation-unverifiable,stub-symbol-missing,symbol-kind-mismatch,duplicate-code,pyi-underscore-symbol,docstring-in-impl,generic-return-requires-returns,internal-helper-docstring-allowed,unjustified-suppression,unnamed-tuple-dict-value,generic-key-dict,use-structured-logging",
        )
